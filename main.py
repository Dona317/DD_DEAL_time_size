...
if __name__ == "__main__":
    ...
    plot.plot_deals_over_time_by_flag(deals, "gafam", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "bigtech_narrow", window=0, log_scale=False)
    #plot.plot_deals_over_time_by_flag(deals, "bigtech_large_excluding_gafamn", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "bigtech_large_composite", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "ai_giant_narrow", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "ai_giant_large", window=0, log_scale=False)
    #plot.plot_deals_over_time_by_flag(deals, "no_bigtech", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "big_no_tech", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "acc_inc_custom", window=0, log_scale=False)
    plot.plot_deals_over_time_by_flag(deals, "acc_inc_pb", window=0, log_scale=False)
    ...
    # Fig 2 – Evolution of # deals by investor category line 4m (Trend of BigTech vs Non-BigTech vs Accelerators)
